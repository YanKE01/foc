                  ...
                  real32_T rty_tABC[3])
{
   ...
   *  Sum: '<S4>/Sum1'
   */
  rty_tABC[0] = (-rty_tABC[0] / rtu_v_bus + 0.5F) * Hardware.Period;
  rty_tABC[1] = (-rty_tABC[1] / rtu_v_bus + 0.5F) * Hardware.Period;
  rty_tABC[2] = (-rty_tABC[2] / rtu_v_bus + 0.5F) * Hardware.Period;
}
...
static void VFmode(void)
{
  ...
  rtb_SinCos1 = cosf(rtb_Sum);

  /* Trigonometry: '<S1>/SinCos' */
  rtb_SinCos = sinf(rtb_Sum);
